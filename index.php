...
<head>
    ...
    <title>Northern Wear Clothing</title>
	...
	<div class="container">
				...
				<div class="tm-header">
					<div class="row tm-header-inner">
						<div class="col-md-6 col-12">
							<img src="images/main.jpg" alt="not_loaded"/>
		...
		<main>
			<header class="row tm-welcome-section">
				<h2 class="col-12 text-center tm-section-title">Exclusive Winter Collection</h2>
				<p class="col-12 text-center">Northern Wear is a collection of best Trending winter clothes for 3 different categories: Men, Women and Kids</p>
